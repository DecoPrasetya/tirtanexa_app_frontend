...
export default function HalamanDetailTryout({ params }: PageProps) {
  ...
  if (!tryoutData) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 text-center p-6 bg-[var(--bg-alt)]">
        <div className="w-20 h-20 bg-[var(--bg-alt)] rounded-full flex items-center justify-center text-[var(--text-muted)] mb-2">
        ...
        <h2 className="text-2xl font-bold text-[var(--text)]">Tryout Tidak Ditemukan</h2>
        <p className="text-[var(--text-muted)] max-w-md">Tryout yang Anda cari mungkin telah dihapus atau tidak tersedia saat ini.</p>
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-alt)] py-8 px-5 sm:px-8 flex flex-col items-center">
      <div className="w-full max-w-4xl flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] text-sm sm:text-base mt-2 max-w-2xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-[var(--surface)] rounded-2xl p-5 sm:p-6 border border-[var(--border)] shadow-sm flex items-center gap-4 hover:border-teal-100 hover:shadow-md transition">
            ...
            <div className="flex flex-col">
              <p className="text-[var(--text-muted)] text-sm font-medium">Durasi Total</p>
              <p className="text-[var(--text)] font-bold text-lg">{tryoutData.duration} Menit</p>
            </div>
          </div>
          <div className="bg-[var(--surface)] rounded-2xl p-5 sm:p-6 border border-[var(--border)] shadow-sm flex items-center gap-4 hover:border-teal-100 hover:shadow-md transition">
            ...
            <div className="flex flex-col">
              <p className="text-[var(--text-muted)] text-sm font-medium">Jumlah Soal</p>
              <p className="text-[var(--text)] font-bold text-lg">{tryoutData.questions} Soal</p>
            </div>
          </div>
          <div className="bg-[var(--surface)] rounded-2xl p-5 sm:p-6 border border-[var(--border)] shadow-sm flex items-center gap-4 hover:border-teal-100 hover:shadow-md transition">
            ...
            <div className="flex flex-col">
              <p className="text-[var(--text-muted)] text-sm font-medium">Sistem Penilaian</p>
              <p className="text-[var(--text)] font-bold text-lg">{tryoutData.system}</p>
            </div>
          </div>
        </div>

        {/* KARTU DAFTAR SUBTES */}
        <div className="w-full bg-[var(--surface)] rounded-2xl border border-[#e2e8f0] shadow-sm overflow-hidden flex flex-col">
          
          <div 
            className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-[8px] border-b border-[#f1f5f9] bg-[var(--surface)]"
            style={{ padding: '24px' }}
          >
          ...
          <ul className="flex flex-col bg-[var(--surface)] w-full divide-y divide-slate-100">
              ...
              >
                <div className="flex flex-col gap-[8px]" style={{ paddingRight: '16px' }}>
                  ...
                  <div className="flex items-center gap-2 ml-9">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--text-muted)]"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
        ...
        <div className="mt-4 text-center pb-10">
          <p className="text-base font-medium text-[var(--text-muted)] flex items-center justify-center gap-2">
