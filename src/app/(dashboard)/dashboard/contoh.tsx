...
export default function DashboardGlobalLayout({
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-alt)]">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-[var(--surface)] border-b border-[var(--border)] z-50 flex items-center px-4">
        {/* <Topbar /> */}
      ...
      <aside className="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] bg-[var(--surface)] border-r border-[var(--border)] z-40 hidden md:block overflow-y-auto">
        {/* <Sidebar /> */}
